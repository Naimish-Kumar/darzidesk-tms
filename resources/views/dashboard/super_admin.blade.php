                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <div class="flex-grow-1 ms-3">
                            ...
                            <div class="d-flex align-items-center justify-content-between">
                                <h4 class="mb-0">{{ $result['totalOrganization'] }}</h4>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="flex-grow-1 ms-3">
                            <p class="mb-1">{{ __('Total Packages') }}</p>
                            <div class="d-flex align-items-center justify-content-between">
                                <h4 class="mb-0">{{ $result['totalSubscription'] }}</h4>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="flex-grow-1 ms-3">
                            <p class="mb-1">{{ __('Total Transaction') }}</p>
                            <div class="d-flex align-items-center justify-content-between">
                                <h4 class="mb-0">{{ $result['totalTransaction'] }}</h4>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="flex-grow-1 ms-3">
                            ...
                            <div class="d-flex align-items-center justify-content-between">
                                <h4 class="mb-0">{{ getSettingsValByName('CURRENCY_SYMBOL') . $result['totalIncome'] }}
                                </h4>
                            </div>
                        </div>
                    </div>
