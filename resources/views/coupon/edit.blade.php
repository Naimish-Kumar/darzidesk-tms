{{ Form::model($coupon, ['route' => ['coupons.update', encrypt($coupon->id)], 'method' => 'PUT']) }}
<div class="modal-body">
    <div class="row">
        ...
        <div class="form-group col-md-6">
            ...
            {{ Form::select('applicable_packages[]', $packages, explode(',', $coupon->applicable_packages), ['class' => 'form-control select2', 'multiple']) }}
        </div>
        <div class="form-group col-md-6">
