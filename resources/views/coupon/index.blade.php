                                    ...
                                    <tr role="row">
                                        ...
                                        <td>
                                            ...
                                            @foreach ($coupon->package($coupon->applicable_packages) as $package)
                                                <span class="badge bg-light-secondary ms-2 f-12"> {{ $package->title }}
                                                </span>
                                            @endforeach
                                        ...
                                        @if (Gate::check('edit coupon') || Gate::check('delete coupon'))
                                            <td class="text-right">
                                                <div class="cart-action">
                                                    {!! Form::open(['method' => 'DELETE', 'route' => ['coupons.destroy', encrypt($coupon->id)]]) !!}
                                                    ...
                                                    @if (Gate::check('edit coupon'))
                                                        <a class="avtar avtar-xs btn-link-secondary text-secondary customModal"
                                                            ...
                                                            href="#"
                                                            data-url="{{ route('coupons.edit', encrypt($coupon->id)) }}"
