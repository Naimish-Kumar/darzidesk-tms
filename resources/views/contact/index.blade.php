                                                    ...
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-end">
                                                            @if (Gate::check('edit contact'))
                                                                <a class="dropdown-item customModal" href="#" data-url="{{ route('contact.edit', encrypt($contact->id)) }}"
                                                                    data-title="{{ __('Edit Contact') }}">   <i class="ti ti-edit"></i>{{ __('Edit') }}</a>

                                                            @endif
                                                            @if (Gate::check('delete contact'))
                                                            {!! Form::open(['method' => 'DELETE', 'route' => ['contact.destroy', encrypt($contact->id)],'id'=>'user-'.encrypt($contact->id)]) !!}
