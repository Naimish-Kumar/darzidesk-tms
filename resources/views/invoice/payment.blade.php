{{Form::open(array('route'=>array('invoice.payment.store',$invoice_id),'method'=>'post'))}}
<div class="modal-body">
    <div class="row">
        ...
        <div class="form-group  col-md-12">
            ...
            {{Form::number('amount',$invoice->getInvoiceDueAmount(),array('class'=>'form-control','step'=>0.1))}}
        </div>
        <div class="form-group">
            {{ Form::label('payment_type', __('Payment Method'), array('class' => 'form-label')) }}
            {!! Form::select('payment_type', $paymentMethod, null, array('class' => 'form-control  select2 select2', 'required' => 'required')) !!}
        </div>
        <div class="form-group ">
