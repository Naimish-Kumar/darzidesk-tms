...
<div class="modal-body">
    <div class="row">
        ...
        <div class="form-group">
            {{Form::label('cloth_type_limit',__('Cloth Type Limit'),array('class'=>'form-label'))}}
            {{Form::number('cloth_type_limit',null,array('class'=>'form-control','placeholder'=>__('Enter cloth type limit'),'required'=>'required'))}}
        </div>
