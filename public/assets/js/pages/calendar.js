...
console.log(clickedevent);
            ...
            var e_date_register = clickedevent.extendedProps.registration_date === null ? '' : dateformat(clickedevent.extendedProps.registration_date);
            var e_url = clickedevent.extendedProps.urls === null ? '' : clickedevent.extendedProps.urls;
            var e_status = clickedevent.extendedProps.status === null ? '' : clickedevent.extendedProps.status;
            ...
            document.querySelector('.pc-event-date-register').innerHTML = e_date_register;
            document.querySelector('.pc-event-status').innerHTML = e_status;
