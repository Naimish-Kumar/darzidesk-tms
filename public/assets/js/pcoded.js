...
// authentication  lightLogo
var tc = document.querySelectorAll('.auth-main.v2 .img-brand');
for (var t = 0; t < tc.length; t++) {
    tc[t].setAttribute('src',  lightLogo);
}
...
function layout_rtl_change(value) {
    ...
    $('#theme_layout').val(result);
}

function layout_change(layout) {
    $('#theme_mode').val(layout);
    var control = document.querySelector('.pct-offcanvas');
    ...
    if (layout == 'dark') {
        ...
        if (document.querySelector('.pc-sidebar .m-header .logo-lg')) {
            document.querySelector('.pc-sidebar .m-header .logo-lg').setAttribute('src',  lightLogo);
        }

        if (document.querySelector('.navbar-brand .logo-lg')) {
            document.querySelector('.navbar-brand .logo-lg').setAttribute('src',  lightLogo);
        }
        if (document.querySelector('.navbar-brand .brand-logo')) {
            document.querySelector('.navbar-brand .brand-logo').setAttribute('src',  lightLogo);
        }
        if (document.querySelector('.navbar-brand .landing-logo')) {
            document.querySelector('.navbar-brand .landing-logo').setAttribute('src',  lightLogo);
        }
        if (document.querySelector('.auth-main .brand-logo')) {
            document.querySelector('.auth-main .brand-logo').setAttribute('src',  lightLogo);
        }
        if (document.querySelector('.footer-top .footer-logo')) {
            document.querySelector('.footer-top .footer-logo').setAttribute('src',  lightLogo);
        }
        ...
        if (document.querySelector('.navbar-brand .brand-logo')) {
            document.querySelector('.navbar-brand .brand-logo').setAttribute('src', logo);
        }
        if (document.querySelector('.navbar-brand .landing-logo')) {
            document.querySelector('.navbar-brand .landing-logo').setAttribute('src', logo);
        }
        if (document.querySelector('.auth-main .brand-logo')) {
            document.querySelector('.auth-main .brand-logo').setAttribute('src', logo);
        }
        if (document.querySelector('.footer-top .footer-logo')) {
